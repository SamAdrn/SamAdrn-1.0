...
function ContactBar() {
    ...
    return (
        <div
            className={
                "flex flex-col justify-center w-full px-3 py-4 gap-8 " +
                "rounded-r-xl shadow-lg fill-neutral-100 md:px-5 md:py-6 " +
                "md:gap-16 lg:flex-row lg:py-3 lg:rounded-lg lg:gap-9 " +
                "lg:mt-5 xl:gap-14 bg-gradient-to-r transition-colors " +
        ...
        >
            {contactIcons.map((e) => (
                <motion.svg
                    key={e.icon}
                    className={
                        "drop-shadow-xl h-6 md:h-10 lg:h-11 cursor-pointer"
                    }
                    ...
                    animate={{
                        opacity:
                            iconOnHover === "none" || iconOnHover === e.icon
                                ? 1
                                : 0.5,
                    }}
                    ...
                    onHoverStart={() => setIconOnHover(e.icon)}
